<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditBed.aspx.cs" Inherits="HospitalManagementSystem.EditBed" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cl" runat="server">


      <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Edit Bed Sit</strong>
                        </div>
                        <div class="card-body">
                          <!-- Credit Card -->
                          <div id="pay-invoice">
                           ...
                           <strong>Bed Update Successfully </strong>
                        </div>
                                  </form>
                              </div>
                          </div>
