<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RequestStock.aspx.cs" Inherits="HospitalManagementSystem.Admin.RequestStock" %>
                               ...
                               <div class="card-body">
                                  ...
                                  <form action="" runat="server" method="post" novalidate="novalidate">
                                      ...
                                      <div class="form-group">
                                          <label for="cc-payment" class="control-label mb-1">Entry/Delievery</label>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <asp:TextBox ID="Renttx" runat="server" CssClass="form-control"></asp:TextBox>
                                           </div>  
