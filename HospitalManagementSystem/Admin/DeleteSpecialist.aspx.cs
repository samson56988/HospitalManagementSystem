...
{
    public partial class DeleteSpecialist : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "delete Specialist where ID='" + Request.QueryString["id2"].ToString() + " ' ";
            cmd.ExecuteNonQuery();
            Response.Redirect("AddSpecialist.aspx");
